...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .oauth2ResourceServer(oauth -> oauth.jwt(jwt -> jwt.jwtAuthenticationConverter(roleBasedConverter())))
                .build();
    }
    ...
    private ReactiveJwtAuthenticationConverterAdapter roleBasedConverter() {
